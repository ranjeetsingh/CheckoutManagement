...
public class PaymentController {
	...
	/**
	 * This method is use for payment
	 * Internally multiple api call
	 * 1-Use create order api call from cart microservices
	 * 2-Use remove item api call from cart microservices
	 * 3-Use dummy payment method and get dummay gateway response
